...
### Question 1: B) A property of the entire system
...
### Question 2: B) Atomicity, Consistency, Isolation, Durability
...
### Question 3: B) Within a partition only
...
### Question 4: C) When written to all in-sync replicas
...
### Question 5: B) Only messages that are committed
**Explanation:** Consumers can only read messages that are committed (written to all in-sync replicas).

### Question 6: C) Has active ZooKeeper session, fetches messages, and has no lag
...
### Question 8: B) zookeeper.session.timeout.ms
...
### Question 10: B) replica.lag.time.max.ms
...
### Question 17: B) NotEnoughReplicasException
**Explanation:** When insufficient replicas are in sync, producers receive NotEnoughReplicasException.

### Question 18: B) Electing an out-of-sync replica as leader
...
### Question 32: B) Only retriable errors
...
### Question 37: B) What consumer does when no valid offset exists
